...
<body>
    <div id="app" class="flex min-h-screen">
        <div class="transform md:translate-x-0 -translate-x-full flex w-full fixed md:relative md:w-1/5 min-h-full transition duration-500 ease-in-out"
            id="sidebar">
            <aside class="flex flex-col w-2/3 md:w-full bg-white min-h-full shadow-2xl">
                ...
                <div class="flex w-full mt-5">
                    <ul class="space-y-2">
                        ...
                        <li class="border-l-4 border-transparent px-4 flex space-x-4 py-2">
                            <span class="material-icons-outlined text-gray-400">flight_takeoff</span>
                            <a href="/destination"
                                class="text-md text-gray-400 font-bold">Destination</a>
                        </li>
                        <li class="border-l-4 border-indigo-400 px-4 flex space-x-4 py-2">
                            <span class="material-icons-outlined text-indigo-400">people</span>
                            <a href="" class="text-md text-indigo-400 font-bold">User</a>
                        </li>
                    </ul>
                </div>
            </aside>
                            ...
                            <div class="flex self-center">
                                ...
                                <div class="dropdown flex justify-center">
                                    <a class="dropbtn no-underline text__navigation flex content-center">
                                        ...
                                        <svg class="fill-current h-4 w-4 flex self-center"
            ...
            <main class="flex flex-col bg-gray-100 flex-grow" id="body">
                ...
                <div class="container mt-5 px-4 md:px-10 mx-auto">
                    <div class="flex justify-between mt-4">
                        <a href="/UserAdd" class="bg-indigo-500 px-5 py-2 rounded text-white">Add data</a>
                        <div class="flex hidden">
                            <h1 class="self-center">Search</h1>
                            <input type="search"
                                class="ml-2 focus:ring focus:ring-opacity-50 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring-indigo-200"
                                id="user_search" />
                        </div>
                    </div>
                    <div class="bg-white shadow-xl rounded-md my-2">
                            ...
                            <tbody>
                                <c:forEach items="${data}" var="u" varStatus="loop">
                                    <tr class="hover:bg-grey-lighter">
                                        ...
                                        <td class="py-4 px-6 border-b border-gray-200">${u.name}</td>
                                        <td class="py-4 px-6 border-b border-gray-200">${u.email}</td>
                                        <td class="py-4 px-6 border-b border-gray-200">${u.level}</td>
                                        <td class="py-4 px-6 border-b border-gray-200">
                                            <div class="space-x-2 flex">
                                                <c:if test="${u.level != 'admin'}">
                                                    <a href="/user/edit?id=${u.id}" class="flex self-center bg-indigo-500 px-5 py-1 rounded text-white">
                                                        Edit
                                                    </a>
                                                    ...
                                                    <form action="UserDetail" method="post">
                                                        ...
                                                        <button
                                                            class="flex self-center bg-red-400 px-5 py-1 rounded text-white">Delete</button>
                                                    </form>
                                                </c:if>
                                            </div>
                                        </td>
